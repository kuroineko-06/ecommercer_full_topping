    ...
    for (const orderItem of orderItems) {
      if (
        ...
        return console.trace(
          "Order creation failed: Invalid product in your order!"
        );
      }
      ...
      if (!cartProduct) {
        await session.abortTransaction();
        return console.trace(
          "Order creation failed: Invalid cart product in your order!"
        );
      }
...
exports.getUserOrder = async function (req, res) {
  try {
